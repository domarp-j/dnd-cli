  ...
  describe("Undo / Redo Functionality", () => {
    ...
    test("help menu lists commands cleanly in noun-first format", () => {
      ...
      try {
        ...
        expect(fullOutput).toContain("(redo | r) [<count>]");
        expect(fullOutput).toContain("hp set <value> <target>...");
        expect(fullOutput).toContain("hp clear (all | <target>...)");
        expect(fullOutput).toContain("res (add | use) <resource> <target>...");
        expect(fullOutput).toContain("res remove <resource> <target>...");
        expect(fullOutput).toContain("res clear (all | <target>...)");
